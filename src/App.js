        ...
        return (
                ...
                <div>
                    <Modal open={open} onClose={this.onCloseModal} onEntered={this.onEntered} classNames={{'modal': 'modal-main'}} center>
                      ...
                      <div className="modal-footer">
                            <div className="button-container">
                              <a href="#" onClick={this.onRemoveImages} className="btn sure"><span>Sure</span></a>
                              <a href="#" onClick={this.onCloseModal} className="btn nope"><span>Nope</span></a>
                            </div>
                      </div>  
                    </Modal>
                    ...
                    <div className="controller-container">
                        ...
                        <div className="button-container parts">
                          <a href="#" onClick={this.onOpenModal} className="btn sure"><span>Delete Images</span></a>
                        </div>
                    </div>
                ...
                <div>
                    <div className="button-container text-center">
                        <a href="#" onClick={this.onResetImages} className="btn nope"><span>Reset Images</span></a>
                    </div>
                    <NotificationContainer/>
                </div>
        );
